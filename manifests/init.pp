...
# @param solr_xms
# @param solr_xmx
# @param solr_log_file_path Used only for Solr < 5.
# @param solr_user
...
# @param solr_restart_handler_enabled Enable restart solr handler
...
class paw_ansible_role_solr (
  ...
  String $solr_log_file_path = '/var/log/solr.log',
...
# Execute the Ansible role using PAR (Puppet Ansible Runner)
  ...
  $playbook_path = "${vardir}/lib/puppet_x/ansible_modules/ansible_role_solr/playbook.yml"
  ...
  par { 'paw_ansible_role_solr-main':
    ...
    playbook_vars => {
      ...
      'solr_xms'                     => $solr_xms,
      'solr_xmx'                     => $solr_xmx,
      'solr_log_file_path'           => $solr_log_file_path,
      'solr_user'                    => $solr_user,
